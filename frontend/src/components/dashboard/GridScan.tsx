...
export default function GridScan({
  ...
  useEffect(() => {
    ...
    // OPTIMIZATION: Hardcode pixel ratio to 1.0 (or even 0.5) to reduce render load
    ...
    let composer = null;
    // OPTIMIZATION: Only enable post if explicitly requested, but it adds massive overhead
    if (enablePost) {
